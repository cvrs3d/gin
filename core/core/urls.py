...
from github_issues.views import GinRepositoryView, GinDeleteRepo, GinUpdateRepo, SearchIssueView,GinAddNewRepo
...
urlpatterns = [
    ...
    path('search_issues/', SearchIssueView.as_view(), name='search_issues'),
